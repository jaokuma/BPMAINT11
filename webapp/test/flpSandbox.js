					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Manutenção de Terceiros",
									"targetURL": "#bpmaint11-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"bpmaint11-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=bpmaint11",
									"url": sap.ui.require.toUrl("bpmaint11")
								}
							}
						}
					}
